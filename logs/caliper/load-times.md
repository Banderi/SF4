...
| XNet                               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | xnet-1.12-1.7.6.jar                                |
| Forge Mod Loader                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | forge-1.12.2-14.23.5.2838-universal.jar            |
| Loading Screens                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | LoadingScreens-1.12.2-0.3.1.jar                    |
| Pickle Tweaks                      | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | PickleTweaks-1.12.2-2.1.3.jar                      |
| Barrels, Drums, Storage & More     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | BarrelsDrumsStorageAndMore-0.0.24.jar              |
| Guide-API                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Guide-API-1.12-2.1.8-63.jar                        |
| Horse Power                        | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | HorsePower-1.12.2-2.6.4.74.jar                     |
| uppers                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Uppers-0.0.6.jar                                   |
| World Utils                        | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | worldutils-1.12.2-0.4.2.jar                        |
| B.A.S.E                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | base-1.12.2-3.11.0.jar                             |
| Game Stages                        | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | GameStages-1.12.2-2.0.115.jar                      |
| Dimension Stages                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | DimensionStages-1.12.2-2.0.23.jar                  |
| Mystcraft                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | mystcraft-1.12.2-0.13.7.04.jar                     |
| SkyBonsais                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | SkyBonsais-1.0.1.jar                               |
| Bonsai Trees                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | bonsaitrees-1.1.3-b156.jar                         |
| Cooking for Blockheads             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CookingForBlockheads_1.12.2-6.4.71.jar             |
| FastWorkbench                      | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FastWorkbench-1.12.2-1.7.2.jar                     |
| Hunting Dimension                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | HuntingDimension-1.12.2-1.0.38.jar                 |
| OpenComputers Xnet Driver          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ocxnetdriver-1.0.3-b17.jar                         |
| Wither Crumbs                      | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | witherCrumbs-1.12.2-0.11.jar                       |
| Real Filing Cabinet                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | realfilingcabinet-1.12-0.2.0.19.jar                |
| Astral Sorcery                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | astralsorcery-1.12.2-1.10.19.jar                   |
| Parabox                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Parabox-1.12.2-2.0.0.jar                           |
...
| Rustic                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | rustic-1.0.15.jar                                  |
...
| Tesla Core Lib                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | tesla-core-lib-1.12.2-1.0.15.jar                   |
